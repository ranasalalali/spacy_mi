...
python pick_N_r_space_passwords.py --r_space 1000 --N 2

filename='r_space_data/50_r_space_passwords.txt'
n=1
while read line; do
# reading each line
...
qsub -v password=$password,start_loc=$start_loc,end_loc=$end_loc,run=$n jobscript;
