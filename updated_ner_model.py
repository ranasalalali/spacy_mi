...
if __name__ == "__main__":
    ...
    print("Size of vocab_string in model after querying: ", len(list(nlp1.vocab.strings)))
    ...
    print("Size of vocab_string in model after querying: ", len(list(nlp2.vocab.strings)))
