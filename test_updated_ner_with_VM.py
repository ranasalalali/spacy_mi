...
if __name__ == '__main__':
    ...
    in_vocab_time_tok, in_vocab_time_ner, in_vocab_time, out_vocab_time_tok, out_vocab_time_ner, out_vocab_time = test_updated_ner_IN_OUT_time_diff_separate_process(num_test)
    f_name = 'time_diff_updated_ner_{}_words_fives_runs_separate_process'.format(num_test)
