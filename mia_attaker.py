...
if __name__ == "__main__":
    ...
    # ax = plt.gca()
    # ax.set_ylim(2.5, 3) 
    plt_dest = plt_folder + 'average_time_difference_40_words_vm_tokenizer_ner.png'
    ...
    # ax = plt.gca()
    # ax.set_ylim(2.5, 3) 
    plt_dest = plt_folder + 'average_time_difference_40_words_vm_tokenizer_only.png'
    plt.savefig(plt_dest, dpi=300, bbox_inches='tight')
    ...
    # ax = plt.gca()
    # ax.set_ylim(2.5, 3) 
    plt_dest = plt_folder + '40w_time_difference_between_two_runs_pc_ner.png'
    plt.savefig(plt_dest, dpi=300, bbox_inches='tight')
