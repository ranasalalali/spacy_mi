...
def save_results(results_holder, f_name):
    ...
    folder = 'password_11116_original_ner_ROC_{}'.format(now)
...
###################################################
def test_orig_ner_IN_OUT(in_vocab_words_test, out_vocab_words_test, num_test): 
    in_vocab_time = []
    out_vocab_time = []
...
def test_orig_ner_IN_OUT_time_diff(in_vocab_words_test, out_vocab_words_test, num_test):
...
def test_orig_ner_IN_OUT_time_avg(in_vocab_test, out_vocab_test, num_test) :
...
if __name__ == '__main__':
    ...
    # in_vocab_runtime_abs, out_vocab_runtime_abs = test_orig_ner_IN_OUT(in_vocab_words_test, out_vocab_words_test, num_test) 
    # f_name = 'abs_runtime_orig_ner_{}_words'.format(num_test)
    # save_results([in_vocab_runtime_abs, out_vocab_runtime_abs], f_name)


    in_vocab_runtime_time_diff, out_vocab_runtime_time_diff = test_orig_ner_IN_OUT_time_diff(in_vocab_words_test, out_vocab_words_test, num_test) 
    f_name = 'time_diff_orig_ner_{}_words_three_runs'.format(num_test)
    save_results([in_vocab_runtime_time_diff, out_vocab_runtime_time_diff], f_name)

    # in_vocab_runtime_time_avg, out_vocab_runtime_time_avg = test_orig_ner_IN_OUT_time_avg(in_vocab_words_test, out_vocab_words_test, num_test) 
