...
def save_results(results_holder, f_name):
    ...
    folder = 'en_core_web_sm_timing_results_ROC_{}'.format(now)
...
if __name__ == "__main__":
    iterations = 10
    file_name = open("attack_en_core_sm_model_ROC_vm.txt","a")
    file_name.write("+++++++++++++++++++++++++++++++++++\n")
    file_name.write("+++++++++++++++++++++++++++++++++++\n")
    ...
    roc_auc_avg_time_graph_name = 'roc_auc_{}_words_en_core_wb_sm_avg_time_vm.png'.format(num_test)
    all_roc_graph_name = 'all_roc_auc_{}_words_en_core_wb.png'.format(num_test)
