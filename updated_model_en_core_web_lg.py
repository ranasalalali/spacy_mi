...
# def target_ner_tokenizer_multiple_words_one_run(text,model):
    
#     nlp, tokeniz, tagger, parser, ner, att_ruler, lemmatizer = load_nlp(model)
#     runtime_list = []
...
def target_ner_tokenizer_one_word_multiple_times(texts, iterations, model):
...
def target_tokenizer_ner_time_diff(texts, model):
...
if __name__ == "__main__":
    ...
    in_vocab_runtime_avg_list = g[0][0]
    out_vocab_runtime_avg_list = g[0][1]
    in_vocab_runtime_time_diff_list = g[0][2]
    out_vocab_runtime_time_diff_list = g[0][3]
